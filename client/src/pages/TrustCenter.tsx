...
import { DIPIZ_STUDIO_LOCATION, DIPIZ_STUDIO_LOCATION_LABEL } from "@/lib/storefrontContact";
...
export default function TrustCenter() {
  ...
  return <div className="trust-page">
    ...
    <main>
      ...
      <section className="care-grid-section"><div className="section-shell"><div className="care-grid"><article><Truck size={20} /><p className="eyebrow">Shipping information</p><h3>Made with time in mind.</h3><p>Ready pieces leave the studio in 2–4 business days. Commission and made-to-order timing is confirmed before each piece begins.</p><p className="studio-location"><MapPin size={14} /> {DIPIZ_STUDIO_LOCATION_LABEL}: {DIPIZ_STUDIO_LOCATION}</p></article><article><RotateCcw size={20} /><p className="eyebrow">Returns &amp; refunds</p><h3>Care if something isn’t right.</h3><p>If a piece arrives damaged or different from what was confirmed, contact the studio within 7 days so we can review and help.</p></article><article><LockKeyhole size={20} /><p className="eyebrow">Secure checkout</p><h3>A clear, protected finish.</h3><p>Checkout-enabled products use the Shopify checkout handoff. Your payment details are never stored inside DIPIZ CREATION.</p></article></div></div></section>
